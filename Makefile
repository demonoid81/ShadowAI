...
build-cli:
	cd backend && for cmd in audit-verify audit-export-evidence evidence-upload audit-evidence-report audit-collect-evidence audit-access-review audit-byok-sweep audit-byok-epochs firewall-corpus-verify shadowai-prod-validate migrate; do \
		echo "Building $$cmd..."; \
